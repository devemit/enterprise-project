      ...
      <div className='about-us__content'>
        ...
        <div className='about-us__content__text-wrapper'>
          <p className='about-us__content__text-one'>
            <span className='about-us__content__text-one__span'>
          ...
          <p className='about-us__content__text-two'>
            <span className='about-us__content__text-two__span'>
          ...
          <p className='about-us__content__text-three'>
            ...
            <span className='about-us__content__text-three__span'> $24 million</span> for
